    ...
    return (
        <div className={'item__wrapper'}>
            ...
            <div className="course__item" style={{width: '200px', borderRadius: '30px', padding: '60px 30px 20px 30px', background: '#8691ca', color: '#fff'}}>
                <h2 style={{marginBottom: '10px', fontSize: '20px', borderBottom: '3px solid #e6ebff', paddingBottom: '10px'}}>{course.course.title}</h2>
                <h3 style={{marginBottom: '10px', color: '#e6ebff', fontSize: '16px'}}>{course.course.theme}</h3>
                {course.author &&
                <div>
                ...
                <div style={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
                    <p className="course__description" style={{textAlign: 'center', fontWeight: 'bold', fontSize: '24px'}}>{course.course.price !== '0' ? '$' + course.course.price : 'Free'}</p>
