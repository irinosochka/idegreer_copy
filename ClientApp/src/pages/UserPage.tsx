            ...
            <div style={{width: '300px', flexGrow: '0', background: '#6675bc', height: 'calc(100vh - 85px)'}}>
                <div className="leftMenu__wrapper">
                    <div className="btn__menu">
                        <EditProfileButton isActive={slideItem === UserPageSlidesItems.ALL_COURSES_LIST} icon={homeIcon} onClick={() => setSlideItem(UserPageSlidesItems.ALL_COURSES_LIST)}>Course Catalog</EditProfileButton>
